...
This is the C# version. We also have a [VB.NET version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_CompositeCommandDemo_VB_x64) avilable.  
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_CompositeCommandDemo_CS_x64.git CompositeCommandDemo --recursive
